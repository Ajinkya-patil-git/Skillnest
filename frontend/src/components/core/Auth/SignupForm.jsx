...
import { signUpWithoutOTP } from "../../../services/operations/authAPI"
...
function SignupForm() {
  ...
  const handleOnSubmit = (e) => {
    ...
    if (!isStrongPassword(password)) {
      toast.error("Password must be at least 8 characters, include uppercase, lowercase, a number, and a special character.");
      return;
    }
