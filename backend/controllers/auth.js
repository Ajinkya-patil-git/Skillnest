...
// Email templates disabled - no email sending
...
exports.sendOTP = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            otp,
            message: 'Otp sent successfully (Email disabled - OTP shown in response)'
        });
    }
...
exports.signup = async (req, res) => {
    try {
        ...
        // OTP verification - DISABLED for simplified setup
...
exports.changePassword = async (req, res) => {
    try {
        ...
        // Email sending disabled - no confirmation email sent
